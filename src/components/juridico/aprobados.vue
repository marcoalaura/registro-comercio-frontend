<template>
  <v-card elevation="0" class="crud-table backgroundColor">
    <section>
      <small>Bandeja de Aprobados</small>
      <p>&nbsp;</p>
      <h2>Bandeja de Aprobados</h2>
      <p>
        En esta sección podrá revisar los trámites aprobados por su persona.
      </p>
    </section>
...
const urlMisTramites = 'juridico/aprobados';
